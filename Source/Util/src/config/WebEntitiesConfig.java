...
public class WebEntitiesConfig {
	 ...
	 * Execution options
	 */
	public static int CONSTRAINT_MAX_LENGTH 		= 20;	// The maximum length of a Constraint
	public static int CONSTRAINT_MAX_ATOMIC_NUM 	= 10;	// The maximum number of atomic predicates in a Constraint
	...
	public static boolean DISCARD_CONSTRAINTS_WHEN_COMPARING_ENTITIES = true;	
